...
public class Lab16Debug2
{
   public static void main(String[] args)
   {
      ...
      int position;
      final String QUIT = "Q";
      System.out.println("Do you want to (A)dd or (R)emove items from list?"); //Added "
      System.out.print("Enter A or R or " + QUIT + " to quit >> ");
      option = kb.nextLine();
      while(!option.equals(QUIT))
      {
         if(!option.equals("A") && !option.equals("R")) // added !
         {
         ...
         else
         {
            if(option.equals("A"))
            {
               ...
               item = kb.nextLine();
               items.add(item); // changed add() --> add(item)
            }
            else
            {
            ...
            System.out.println
               ("Do you want to (A)dd or (R)emove items from list?");
            System.out.print("Enter A or R or " + QUIT + " to quit >> "); // added ;
            option = kb.nextLine();
         }
      }
   }
